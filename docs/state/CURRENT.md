...
- status: in-progress（T-801/T-802 已完成；T-803-3A 共享 HTTP client 已完成，下一棒 3B）
...
3. T-803：性能基线、profiling、共享 HTTP client、索引与 I/O。← 进行中（3A ✅）
