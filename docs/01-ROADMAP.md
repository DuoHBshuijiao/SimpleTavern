...
- T-802 前五批已完成：LLM/generate、Storage/chat/fork、Assistant/tools、MVU/KG/regex health（含 F-009）、Search/Import-Export。
- 当前门禁：后端 191 tests；1000 会话 fork 索引冷重建 410.05 ms。
- T-802 下一批为 TTS / infra（F-030~F-034）。
