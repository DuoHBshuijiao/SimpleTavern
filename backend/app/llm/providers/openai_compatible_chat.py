"""
OpenAI-compatible Chat Completions provider adapter (T-804).

Implementation moved from `app.llm.openai_compat` so the kernel registry can
own protocol routing while the public `openai_compat` module remains a stable ABI.
"""
...
def decode_usage(raw: dict[str, Any] | None) -> Any:
    """Normalize OpenAI-style usage object; None when absent/unusable."""
...
class OpenAICompatibleChatAdapter:
    """ProviderAdapter implementation for OpenAI Chat Completions compatible APIs."""
    ...
    def build_request(
        ...
        *,
        ...
        from app.llm.types import GenerationConfig, WireRequest
    ...
    async def complete(
        ...
        *,
        ...
        return await chat_completions(**kwargs)
    ...
    def decode_usage(self, raw: dict[str, Any] | None):
